    ...
    try {
        const gptResponse = await fetch("https://api.openai.com/v1/chat/completions", {
            ...
            headers: {
                ...
                "Authorization": `Bearer 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`,
            },
            body: JSON.stringify({
                model: "gpt-4o",
                messages: [
